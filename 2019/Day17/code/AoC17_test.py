# Test file for Advent of Code 2019: https://adventofcode.com/2019/day/17

import unittest
from AoC17_classes import Scaffoliding, Compute



class TestScaffoldingMap(unittest.TestCase):
    ...
    def test_ascii_program(self):
        # arrange
        infile = open('data/input_17.txt','r')
        program = infile.readline().strip().split(',')
        # program[0] = 2
        a = Scaffoliding(program)
        result = []
